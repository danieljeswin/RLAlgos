...
class DuelingDQNAgent:
    def __init__(self, env_name):
        ...
        self.writer = SummaryWriter(comment = 'duelingdqn' + self.env_name)
        self.total_rewards = []
        ...
        while True:
            ...
            if done:
                ...
                if self.best_mean_reward is None or self.best_mean_reward < mean_reward:
                    torch.save(self.network.state_dict(), self.env_name + "-myduelingdqnbest.pth")    
    ...
    def run_test_episode(self):
        ...
        self.network.load_state_dict(torch.load(self.env_name + "-myduelingdqnbest.pth"))
